...
def gather(args):
    ...
    if args.url:
        ...
        url_list.harvest(max_depth=args.depth, update_inplace=args.override, raise_on_optional=args.test,
                         dump_result=True)
    elif args.file:
        ...
        for line in fileinput.input():
            ...
            url_list.harvest(max_depth=args.depth, update_inplace=args.override, raise_on_optional=args.test, dump_result=True)
